...
namespace HomeServiceProvider.UnitOfWork
{
    public class UnitOfWork : IUnitOfWork
    {
        ...
        private IRepository<AiPromptTemplate>? _aiPromptTemplates;

        public IRepository<AiPromptTemplate> AiPromptTemplates
            => _aiPromptTemplates ??= new Repository<AiPromptTemplate>(_context);
        // ADD property:
        public IRepository<SearchAnalyticsLog> SearchAnalyticsLogs
            => _searchAnalyticsLogs ??= new Repository<SearchAnalyticsLog>(_context);
